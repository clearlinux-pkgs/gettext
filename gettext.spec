...
Source0  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.tar.xz
Source1  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.tar.xz.sig
...
%prep
%setup -q -n gettext-0.22
cd %{_builddir}/gettext-0.22
pushd ..
cp -a gettext-0.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687382184
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libgettextlib-0.22.so
/V3/usr/lib64/libgettextsrc-0.22.so
...
/V3/usr/lib64/libgettextpo.so.0.5.9
/V3/usr/lib64/libtextstyle.so.0.2.0

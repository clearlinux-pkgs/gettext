...
Source0  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.4.tar.xz
Source1  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.4.tar.xz.sig
...
%prep
%setup -q -n gettext-0.22.4
cd %{_builddir}/gettext-0.22.4
pushd ..
cp -a gettext-0.22.4 buildavx2
popd
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libgettextlib-0.22.4.so
/V3/usr/lib64/libgettextsrc-0.22.4.so
...
/usr/lib64/libgettextlib-0.22.4.so
/usr/lib64/libgettextlib.so
/usr/lib64/libgettextpo.so
/usr/lib64/libgettextsrc-0.22.4.so

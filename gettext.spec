...
Source0  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.5.tar.xz
Source1  : https://mirrors.kernel.org/gnu/gettext/gettext-0.22.5.tar.xz.sig
...
%prep
%setup -q -n gettext-0.22.5
cd %{_builddir}/gettext-0.22.5
pushd ..
cp -a gettext-0.22.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708623896
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/gettext/cldr-plurals
/V3/usr/lib64/gettext/hostname
/V3/usr/lib64/gettext/urlget
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libgettextlib-0.22.5.so
/V3/usr/lib64/libgettextsrc-0.22.5.so
...
/usr/lib64/libgettextlib-0.22.5.so
/usr/lib64/libgettextlib.so
/usr/lib64/libgettextpo.so
/usr/lib64/libgettextsrc-0.22.5.so
...
/V3/usr/lib64/libgettextpo.so.0.5.10
/V3/usr/lib64/libtextstyle.so.0.2.1
/usr/lib64/libasprintf.so.0
/usr/lib64/libasprintf.so.0.0.0
/usr/lib64/libgettextpo.so.0
/usr/lib64/libgettextpo.so.0.5.10
/usr/lib64/libtextstyle.so.0
/usr/lib64/libtextstyle.so.0.2.1

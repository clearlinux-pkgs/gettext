...
Version  : 0.23.1
Release  : 46
URL      : https://mirrors.kernel.org/gnu/gettext/gettext-0.23.1.tar.gz
Source0  : https://mirrors.kernel.org/gnu/gettext/gettext-0.23.1.tar.gz
Source1  : https://mirrors.kernel.org/gnu/gettext/gettext-0.23.1.tar.gz.sig
...
Requires: gettext-libexec = %{version}-%{release}
...
%package libexec
Summary: libexec components for the gettext package.
Group: Default
Requires: gettext-license = %{version}-%{release}

%description libexec
libexec components for the gettext package.
...
%setup -q -n gettext-0.23.1
cd %{_builddir}/gettext-0.23.1
pushd ..
cp -a gettext-0.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735929096
...
rm -f %{buildroot}*/usr/share/doc/gettext/examples/build-aux/csharpexec-test.exe
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libgettextlib-0.23.1.so
/V3/usr/lib64/libgettextsrc-0.23.1.so
/V3/usr/lib64/preloadable_libintl.so
...
/usr/lib64/libgettextlib-0.23.1.so
/usr/lib64/libgettextlib.so
/usr/lib64/libgettextpo.so
/usr/lib64/libgettextsrc-0.23.1.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libasprintf.so.0.0.0
/V3/usr/lib64/libgettextpo.so.0.5.12
/V3/usr/lib64/libtextstyle.so.0.2.3
/usr/lib64/libasprintf.so.0
/usr/lib64/libasprintf.so.0.0.0
/usr/lib64/libgettextpo.so.0
/usr/lib64/libgettextpo.so.0.5.12
/usr/lib64/libtextstyle.so.0
/usr/lib64/libtextstyle.so.0.2.3

%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/gettext/cldr-plurals
/V3/usr/libexec/gettext/hostname
/V3/usr/libexec/gettext/urlget
